...
export default class jsTPS {
    ...
    addTransaction(transaction) {
        ...
        // AND EXECUTE IT
        // slight modification to the original jsTPS
        // so everyone else can do the way they did it in playlister
        // but i needed smthn specific
        if(Object.hasOwn(transaction, 'dontDo')){
