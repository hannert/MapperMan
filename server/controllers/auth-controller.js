...
sendVerification = async (req, res) => {
    ...
    try {
        ...
        const message = `
            <p>Hi! You have requested to do a password reset. Please click <a href=mapperman.netlify.app/changePassword/${existingUser._id}/${t.token}>here</a> to verify and complete it!</p>
            <p>Regards, </p>
            <p>Mapperman team</p>`
